...
| 41 | **E** | `128_verification_precoce_email_client.sql` | Bloque dès la première étape une adresse client déjà associée à un compte ou un dossier, avec une réponse booléenne minimale. |
