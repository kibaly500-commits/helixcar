...
| 37 | **E** | `124_civilite_partenaire.sql` | Ajoute la civilité partenaire (`Madame`, `Monsieur`, `Je préfère ne pas préciser`) ; les valeurs absentes ou non précisées conservent le masculin par défaut dans le dashboard. |
