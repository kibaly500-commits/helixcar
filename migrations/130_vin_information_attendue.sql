-- PR6 lot 130 — le VIN absent reste non bloquant pour le devis,
-- mais devient une information attendue, visible et transmissible
-- depuis les espaces client et administrateur, comme l'immatriculation.
-- ============================================================
