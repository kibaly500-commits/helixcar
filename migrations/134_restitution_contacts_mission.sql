-- Migration corrective distincte : la migration 132 avait déjà été appliquée.
-- Ajoute les contacts de restitution sans dépendre du rejeu de 132.

-- PR6 lot 132 — VIN et immatriculation de chaque véhicule à restituer.
-- Ils restent non bloquants pour la création et l'envoi du devis, mais
-- deviennent des informations attendues et bloquent le lancement de mission.
-- ============================================================
