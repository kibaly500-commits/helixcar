...
function _construirePdfDevis(c, d) {
  ...
  var _estMultiIndividuelTrajet = ((_nbVehiculesTrajet >= 2
    || (c._vehicules && c._vehicules.length)) && c.trajet_commun !== true);
  ...
  // « mono historique » signifie désormais : un véhicule ET aucune vraie
  // ligne dans `vehicules`. Dès qu'une ligne existe, ses adresses, dates et
  // horaires sont la source exacte, même si le compteur vaut 1.
  var _monoPdf = _nbVehPdf < 2 && !(c._vehicules && c._vehicules.length);
